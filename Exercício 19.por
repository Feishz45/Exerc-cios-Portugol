programa
{
	funcao inicio()
	{
		...
		limpa ()
		escreva ("O nùmero de pessoas que se indentificam com sexo masculino foram: ", num1, 
		"\nO nùmero de pessoas que se identificam com sexo feminino foram: ", num2,
		"\nO Número de pessoas que não quiseram se identifcar foram: ", num3)
		escreva("\n")
	}
}
/* $$$ Portugol Studio $$$ 
